...
latex_documents = [
  ('index', 'Classification.tex', u'Classification Documentation',
   u'Uday Kiran Jayanthi', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'Classification Documentation',
     [u'Uday Kiran Jayanthi'], 1)
]
